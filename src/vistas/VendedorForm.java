...
public class VendedorForm extends javax.swing.JInternalFrame {
    ...
    void listar(){
        List<EntidadVendedor> lista = vd.listar();
    ...
    private void initComponents() {
        ...
        tabla.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "DNI", "NOMBRES", "TELEFONO", "USER", "ESTADO"
            }
        ));
    ...
    void agregar(){
        if(txtDni.getText().equals("") || txtNombres.getText().equals("") || txtTelefono.getText().equals("") || txtEstado.getSelectedItem().equals("SELECCIONAR") || txtUser.getText().equals("")){
